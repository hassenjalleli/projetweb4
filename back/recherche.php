...
$listeReclamation1=$ReclamationC->afficherReclamation();
}
else{
	
	$listeReclamation=$ReclamationC->rechercheReclamation($_GET['recherche']);
	$listeReclamation1=$ReclamationC->afficherReclamation();
...
<datalist id="browsers">
	<?PHP
foreach($listeReclamation1 as $rows){
...
foreach($listeReclamation as $row){
  ...
  <td><a href="modifierReclamation.php?id=<?PHP echo $row['id']; ?>" style="text-decorations:none; color:white;"  class="btn btn-warning">
  Modifier</a></td>
  </tr>
  <?PHP
}
