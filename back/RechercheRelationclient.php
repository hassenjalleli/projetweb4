        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li><a href="RechercheRelationclient.<?php  ?>">Recherche</a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg ds">
            ...
            <div class="donut-main">
            	<form method="get" action="RechercheRelationclient.php">
<div class="form-row">
...
foreach($listeEmploye as $row){
  ...
  <td><a href="modifierRelationclient.php?id=<?PHP echo $row['id']; ?>" style="text-decorations:none; color:white;"  class="btn btn-warning">
  Modifier</a></td>
  </tr>
  <?PHP
}
