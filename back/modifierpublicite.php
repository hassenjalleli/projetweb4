...
if (isset($_POST['modifier'])){
    $publicite=new Publicite($_POST['id'],$_POST['nom'],$_POST['fichier']);
    $publiciteC->modifierpublicite($publicite,$_POST['id']);
    echo $_POST['id_ini'];
...
<body>
 ...
 <div class="form-group">
            <div class="col-md-6">
              ...
              <input name="id" class="form-control" placeholder="nom" type="text"value="<?PHP echo $id ?>"/>
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="col-md-6">
              ...
              <input name="nom" class="form-control" placeholder="description" type="text"value="<?PHP echo $nom ?>"/>
            </div>
          </div>
          <div class="form-group">
            <div class="col-md-6">
              <label class="control-label" for="email">fichier</label>
              <input  type="file"name="fichier" class="form-control" placeholder="description" type="text"value="<?PHP echo $fichier ?>"/>
            </div>
          </div>
