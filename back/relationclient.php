...
<div id="wrapper" class="container">
  ...
  <h1>Relation Client</h1>
    ...
    <form id="form-work"method="POST" class="" name="form-work" action="../views/ajoutRelationclient.php" method="GET">
      ...
      <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            <div class="col-md-6">
              <label class="control-label" for="tel">Prenom</label>
          ...
          <div class="form-group">
            <div class="col-md-6">
              ...
              <input name="Gouvernorat" class="form-control" placeholder="Gouvernorat" type="text">
            </div>
          </div>
        <div class="form-group">
            <div class="col-md-6">
              <label class="control-label" for="district">Ville</label>
              <input name="Ville" class="form-control" placeholder="Ville" type="text">
            </div>
          </div>
          <div class="form-group">
            <div class="col-md-6">
              <label class="control-label" for="district">CodePostal</label>
              <input name="CodePostal" class="form-control" placeholder="CodePostal" type="text">
            </div>
          </div>
         <div class="form-group">
            <div class="col-md-6">
          ...
          <div class="form-group">
            <div class="col-md-6">
          <label class="control-label" for="district">Password</label>
