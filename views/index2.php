					...
					<ul class="navbar-nav navbar-right">
						...
						<li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg d-flex">
								<span class="mr-3 mt-2 d-none d-lg-block ">
									<span class="text-white">Hello,<span class="ml-1"> <?php echo $username; ?></span></span>
								</span>
							<span><img src="../assets/img/avatar/avatar-3.jpg" alt="profile-user" class="rounded-circle w-32 mr-2"></span>
							</a>
							<div class="dropdown-menu dropdown-menu-right">
								<div class=" dropdown-header noti-title text-center border-bottom pb-3">
									<h5 class="text-capitalize text-dark mb-1"><?php echo $username; ?></h5>
								</div>
...
foreach($liste as $row){
	...
	?>
							<div class="nav-link pl-1 pr-1 leading-none ">
								...
								<img src="../../../Bureau/<?php echo $row['img'];?>" alt="user-img" class="avatar-xl rounded-circle mb-1">
								<span class="pulse bg-success" aria-hidden="true"></span>
								
							</div>
							
							<div class="user-info">
								<h6 class=" mb-1 text-dark"><?php echo $username; ?></h6>
					...
					<ul class="side-menu">
						...
						<li>
							<a class="side-menu__item" href="forum.php"><i class="side-menu__icon fe fe-grid"></i><span class="side-menu__label">forum</span></a>
						</li>
						<li class="slide">
...
<div class="box">
        ...
        <tbody>
            ...
            <tr>
				<div class="butt">
			<td ><a href="modifiercompte.php?idclient=<?PHP echo $row['id']; ?>">
<button class="btn btn-warning">Modifier</button>
</a>	</td>
                <td  ><form method="POST" action="supprimercompteutilisateur.php">
